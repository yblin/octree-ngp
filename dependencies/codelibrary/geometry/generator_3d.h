...
#ifndef CODELIBRARY_GEOMETRY_GENERATOR_3D_H_
#define CODELIBRARY_GEOMETRY_GENERATOR_3D_H_
...
/**
 * Randomly generate 3D points (almost) on the sphere.
 */
template <typename T>
...
#endif // CODELIBRARY_GEOMETRY_GENERATOR_3D_H_
