...
#ifndef CODELIBRARY_GEOMETRY_SEGMENT_3D_H_
#define CODELIBRARY_GEOMETRY_SEGMENT_3D_H_
...
public:
    ...
    friend std::ostream& operator <<(std::ostream& os, const Segment3D& seg) {
        Message msg(seg.lower_point(), seg.upper_point());
        return os << msg;
    }
...
#endif // CODELIBRARY_GEOMETRY_SEGMENT_3D_H_
