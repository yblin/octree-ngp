...
#ifndef CODELIBRARY_UTIL_COLOR_RGB_COLOR_H_
#define CODELIBRARY_UTIL_COLOR_RGB_COLOR_H_
...
struct RGBColor {
public:
    static const RGBColor Red()      { return {1.0, 0.0, 0.0}; }
    static const RGBColor Green()    { return {0.0, 1.0, 0.0}; }
    static const RGBColor Blue()     { return {0.0, 0.0, 1.0}; }
    static const RGBColor White()    { return {1.0, 1.0, 1.0}; }
    static const RGBColor Black()    { return {0.0, 0.0, 0.0}; }
    static const RGBColor Gray()     { return {0.5, 0.5, 0.5}; }
    static const RGB32Color Yellow() { return {1.0, 1.0, 0.0}; }
    ...
    RGB32Color ToRGB32Color() const {
        return RGB32Color(static_cast<int>(red_   * 255.0),
...
#endif // CODELIBRARY_UTIL_COLOR_RGB_COLOR_H_
