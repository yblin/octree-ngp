...
#ifndef CODELIBRARY_UTIL_COLOR_LAB_COLOR_H_
#define CODELIBRARY_UTIL_COLOR_LAB_COLOR_H_

#include <algorithm>
#include <cmath>

#include "codelibrary/util/color/xyz_color.h"
...
#endif // CODELIBRARY_UTIL_COLOR_LAB_COLOR_H_
