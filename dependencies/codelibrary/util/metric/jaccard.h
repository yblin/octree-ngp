...
#ifndef CODELIBRARY_UTIL_METRIC_JACCARD_H_
#define CODELIBRARY_UTIL_METRIC_JACCARD_H_
...
public:
    ...
    Jaccard(const Jaccard&) = delete;

    Jaccard& operator=(const Jaccard&) = delete;
...
#endif // CODELIBRARY_UTIL_METRIC_JACCARD_H_
