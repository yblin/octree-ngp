...
#ifndef CODELIBRARY_MATH_NUMBER_EXACT_FLOAT_H_
#define CODELIBRARY_MATH_NUMBER_EXACT_FLOAT_H_
...
public:
    ...
    ExactFloat& Multiply(const ExactFloat& a, const ExactFloat& b) {
        if (a.exponent_ < 0 && b.exponent_ < 0) {
            CHECK(a.exponent_ + b.exponent_ < a.exponent_)
                    << "Exponenet overflow.";
...
#endif // CODELIBRARY_MATH_NUMBER_EXACT_FLOAT_H_
