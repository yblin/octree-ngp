...
#ifndef CODELIBRARY_TEST_GRAPH_FLOW_PUSH_RELABEL_MAX_FLOW_TEST_H_
#define CODELIBRARY_TEST_GRAPH_FLOW_PUSH_RELABEL_MAX_FLOW_TEST_H_
...
TEST(PushRelabelMaxFlowTest, Test) {
    using Edge = Graph::Edge;
    graph::PushRelableMaxFlow<int> max_flow;
...
#endif // CODELIBRARY_TEST_GRAPH_FLOW_PUSH_RELABEL_MAX_FLOW_TEST_H_
