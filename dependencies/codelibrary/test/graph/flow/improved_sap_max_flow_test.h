...
#ifndef CODELIBRARY_TEST_GRAPH_FLOW_IMPROVED_SAP_MAX_FLOW_TEST_H_
#define CODELIBRARY_TEST_GRAPH_FLOW_IMPROVED_SAP_MAX_FLOW_TEST_H_
...
TEST(ImprovedSAPMaxFlowTest, Test) {
...
#endif // CODELIBRARY_TEST_GRAPH_FLOW_IMPROVED_SAP_MAX_FLOW_TEST_H_
